...
function valText(a){var s=/^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$/,n=s.test(a.val());a.val().length<1?(a.siblings("span").remove(),a.after("<span class='error-input'>Campo requerido")):(a.siblings("span").remove(),n?a.siblings("span").remove():(a.siblings("span").remove(),a.after('<span class="error-input"> Solo se aceptan letras </span>'),a.siblings("span").show()))}function valTextNum(a){if(a.val().length<1)a.siblings("span").remove(),a.after("<span class='error-input'>Campo requerido");else{a.siblings("span").remove();/^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$/.test(a.val())?a.siblings("span").remove():(a.siblings("span").remove(),a.after('<span class="error-input"> No se permiten caracteres especiales </span>'),a.siblings("span").show())}}function valMail(a){if(a.val().length<1)a.siblings("span").remove(),a.after("<span class='error-input'>Campo requerido");else{/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(a.val())?a.siblings("span").remove():(a.siblings("span").remove(),a.after('<span class="error-input"> Verifica el formato de email </span>'),a.siblings("span").show())}}function validacionContacto(){$("#enviarContacto").on("click",function(){var a=$("#nombreContacto"),s=$("#emailContacto"),n=$("#msjContacto");return valText(a),valMail(s),valTextNum(n),0==$("#formContacto .error-input").length&&$("#formContacto").submit(),!1})}window.onload=function(){validacionContacto()};
