...
function drawSvgServicios(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathNuestros"),i=$("#pathCertificaciones");e(a),e(i);var o=new ScrollMagic.Controller,s=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),t=(new TimelineMax).add(TweenMax.to(i,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerNuestros",duration:600,tweenChanges:!0}).setTween(s).addTo(o),new ScrollMagic.Scene({triggerElement:"#triggerCertificaciones",duration:600,tweenChanges:!0}).setTween(t).addTo(o)}function tabsPromos(){$("#myTab a").on("click",function(e){$(".nav-item").removeClass("active"),$(this).parent("li").addClass("active"),$(".nav-tabs").addClass("nav-active")})}function carruselServicios1(){new Swiper(".sliderServicios1",{observer:!0,observeParents:!0,loop:!0,direction:"horizontal",pagination:{el:"#pag1",type:"bullets",clickable:!0},navigation:{nextEl:"#nav2",prevEl:"#nav1"},breakpoints:{320:{slidesPerView:1,spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:3,slidesOffsetAfter:100}}})}function carruselServicios2(){new Swiper(".sliderServicios2",{observer:!0,observeParents:!0,loop:!0,direction:"horizontal",pagination:{el:"#pag2",type:"bullets",clickable:!0},navigation:{nextEl:"#nav3",prevEl:"#nav4"},breakpoints:{320:{slidesPerView:1,spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:"3",slidesOffsetAfter:100}}})}function carruselServicios3(){new Swiper(".sliderServicios3",{direction:"horizontal",observer:!0,observeParents:!0,loop:!0,pagination:{el:"#pag3",type:"bullets",clickable:!0},navigation:{nextEl:"#nav5",prevEl:"#nav6"},breakpoints:{320:{slidesPerView:1,spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:"3",slidesOffsetAfter:100}}})}function carruselCertificados(){new Swiper(".sliderCertificaciones",{direction:"horizontal",pagination:{el:"#paginador2",type:"bullets",clickable:!0},breakpoints:{320:{slidesPerView:1,spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:"auto",spaceBetween:10,slidesOffsetAfter:30,allowTouchMove:!1}}})}function modalServicios(e){if(window.matchMedia("(max-width: 992px)").matches){$(".nav-item").each(function(e,a){$(this).attr("data-target","#servicio"+e),$(this).attr("data-toggle","modal")});var a=$(".tab-pane");3==$("#myTabContent .modal").length||a.each(function(e,a){$(this).wrapAll("<div class='modal fade' id='servicio"+e+"' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'><div class='modal-dialog' role='document'><div class='modal-content'><div class='modal-body'>")}),$(".modal").each(function(e,a){$(this).find(".modal-body").prepend('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>')})}else{var a=$(".tab-pane");$("#myTabContent .modal").remove(),$("#myTabContent").append(a)}}$(document).ready(function(){window.location.href.indexOf("servicios")>-1&&(drawSvgServicios(),carruselServicios1(),carruselServicios2(),carruselServicios3(),carruselCertificados(),tabsPromos(),modalServicios(),$(window).resize(function(){modalServicios()}))});
