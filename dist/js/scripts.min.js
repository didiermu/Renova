...
function anclas(){$(".hero--links__link").on("click",function(){var e=$(this).attr("id").replace("link-","");$("."+e).offset().top;return $("html, body").animate({scrollTop:$("."+e).offset().top-90},1500),!1})}function drawSvgMateriales(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathDedicamos"),t=$("#pathContacto");e(a),e(t);var r=new ScrollMagic.Controller,s=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),i=(new TimelineMax).add(TweenMax.to(t,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(s).addTo(r),new ScrollMagic.Scene({triggerElement:"#triggerContacto",duration:600,tweenChanges:!0}).setTween(i).addTo(r)}function tabsMateriales(){$(".swiper-slide a").on("click",function(e){switch($(this).attr("id").replace("-tab","")){case"retorno":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/01-retornoindustrial.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/01-retornoindustrial.png");break;case"plasticos":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/02-plasticos.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/02-plasticos.png");break;case"metales":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/03-metalesyacero.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/03-metalesyacero.png");break;case"materiales":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/04-materialescomerciales.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/04-materialescomerciales.png");break;case"carton":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/05-cartonymadera.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/05-cartonymadera.png");break;case"basura":$(".grid--img source").attr("srcset","img/Desktop/3Materiales/06-gestiondebasura.webp"),$(".grid--img img").attr("src","img/Desktop/3Materiales/06-gestiondebasura.png")}})}function carruselMateriales(){var e=new Swiper(".sliderMateriales",{direction:"horizontal",loop:!0,centeredSlidesBounds:!0,slidesPerView:"auto",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{320:{spaceBetween:10,allowTouchMove:!0},992:{spaceBetween:30,allowTouchMove:!1}}});tabsMateriales(),$(".swiper-slide").on("click",function(a){var t=$(this).attr("aria-label").split("/")[0]-1;$(".swiper-slide").removeClass("active"),$(this).addClass("active"),e.slideTo(t,1e3,!0)})}function carruselPromos(){new Swiper(".sliderPromos",{direction:"horizontal",centeredSlidesBounds:!0,navigation:{nextEl:"#prev2",prevEl:"#prev1"},pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},breakpoints:{320:{slidesPerView:"auto",spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:"auto",spaceBetween:10,slidesOffsetAfter:30,allowTouchMove:!1}}})}$(document).ready(function(){window.location.href.indexOf("materiales")>-1&&(anclas(),carruselMateriales(),carruselPromos(),drawSvgMateriales())});
