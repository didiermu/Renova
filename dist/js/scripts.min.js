...
function menu(){$(".header--navegacion .btn").on("click",function(){$(".header").toggleClass("headerOn"),$(this).toggleClass("nav-on")})}function efectoLogo(){function e(){console.log(s),s+=1,i=setTimeout(e,1e3),6==s&&(s=0,$("#logo1").removeClass("logoGiro"))}function o(){t||(t=1,e())}function n(){$("section").each(function(){var e=$(this).offset().top;$(window).scrollTop()>e&&($("#logo1").addClass("logoGiro"),o())})}var i,s=0,t=0;n(),$(document).scroll(function(){n()})}function efectoFade(){function e(){$("section").each(function(){var e=$(this).offset().top-400;$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$("section").removeClass("sectionOn"),$(this).addClass("sectionOn")):$(this).find($(".objetFade")).removeClass("transition1")}),$(".dedicamos").hasClass("sectionOn")?$(".header").addClass("black"):$(".header").removeClass("black")}e(),$(document).scroll(function(){e()})}function efectoFadeServicios(){window.addEventListener("scroll",function(){var e=$("section");setTimeout(function(){$("#logo1").removeClass("logoGiro")},5e3),e.each(function(){var e=$(this).offset().top-300;$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$(this).addClass("sectionOn"),$("#logo1").addClass("logoGiro")):($(this).find($(".objetFade")).removeClass("transition1"),$(this).removeClass("sectionOn"))})},!1)}function efectoParallax(){var e=0,o=0;window.addEventListener("scroll",function(){var n=$(".objParallax"),i=n.parents("section").offset().top-400,s=$(window).scrollTop(),t=n.parents("section").height()+300,a=i+t;if(s>i&&s<a){var l=window.pageYOffset||document.documentElement.scrollTop;l>e?(o+=.3,n.css("transform","translateY("+o+"px)")):(o-=.3,n.css("transform","translateY("+o+"px)")),e=l<=0?0:l}},!1)}function carruselServicios1(){new Swiper(".sliderServicios",{init:!1,direction:"horizontal",pagination:{el:"#pag1",type:"bullets",clickable:!0},navigation:{nextEl:"#nav1",prevEl:"#nav2"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}}).init()}function carruselServicios2(){new Swiper(".sliderServicios2",{direction:"horizontal",pagination:{el:"#pag2",type:"bullets",clickable:!0},navigation:{nextEl:"#nav3",prevEl:"#nav4"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}})}function carruselServicios3(){new Swiper(".sliderServicios3",{direction:"horizontal",pagination:{el:"#pag3",type:"bullets",clickable:!0},navigation:{nextEl:"#nav5",prevEl:"#nav5"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}})}$(document).ready(function(){menu(),efectoLogo(),efectoFade(),$("#myTab a").on("click",function(e){$(".nav-item").removeClass("active"),$(this).parent("li").addClass("active"),$(".nav-tabs").addClass("nav-active")})});
