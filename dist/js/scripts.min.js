...
function menu(){$(".header--navegacion .btn").on("click",function(){$(".header").toggleClass("headerOn"),$(this).toggleClass("nav-on")})}function efectoFade(){function e(){$("section").each(function(){var e=$(this).offset().top-400;$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$(this).addClass("sectionOn")):($(this).find($(".objetFade")).removeClass("transition1"),$(this).removeClass("sectionOn"))}),$(".dedicamos").hasClass("sectionOn")||$(".contacto").hasClass("sectionOn")?($(".header").addClass("black"),$(".hero").removeClass("sectionOn"),$(".ayuda").removeClass("sectionOn")):($(".promos").hasClass("sectionOn")||$(".hero").hasClass("sectionOn")||$(".ayuda").hasClass("sectionOn"))&&($(".header").removeClass("black"),$(".dedicamos").removeClass("sectionOn"),$(".contacto").removeClass("sectionOn")),$(".promos").hasClass("sectionOn")&&($(".header").removeClass("black"),$(".dedicamos").removeClass("sectionOn")),$(".contacto").hasClass("sectionOn")&&($(".header").removeClass("black"),$(".promos").removeClass("sectionOn"))}e(),$(document).scroll(function(){e()})}function efectoParallax(){var e=0,s=0;window.addEventListener("scroll",function(){var o=$(".objParallax"),n=o.parents("section").offset().top-400,a=$(window).scrollTop(),i=o.parents("section").height()+300,t=n+i;if(a>n&&a<t){var c=window.pageYOffset||document.documentElement.scrollTop;c>e?(s+=.3,o.css("transform","translateY("+s+"px)")):(s-=.3,o.css("transform","translateY("+s+"px)")),e=c<=0?0:c}},!1)}function carruselServicios1(){new Swiper(".sliderServicios",{direction:"horizontal",pagination:{el:"#recoleccion .swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:"#recoleccion .swiper-button-next",prevEl:"#recoleccion .swiper-button-prev"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}})}function carruselServicios2(){new Swiper(".sliderServicios2",{direction:"horizontal",pagination:{el:"#servicio .swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:"#servicio .swiper-button-next",prevEl:"#servicio .swiper-button-prev"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}})}window.onload=function(){menu(),efectoFade(),$("#myTab a").on("click",function(e){e.preventDefault(),$(".nav-item").removeClass("active"),$(this).parent("li").addClass("active"),$(".nav-tabs").addClass("nav-active"),carruselServicios1(),carruselServicios2()})};
