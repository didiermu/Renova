...
function drawSvgDestacamos(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathDedicamos"),o=$("#pathMision"),n=$("#pathAyuda"),t=$("#pathEsfuerzo");e(a),e(o),e(n),e(t);var s=new ScrollMagic.Controller,i=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),r=(new TimelineMax).add(TweenMax.to(o,.3,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),d=(new TimelineMax).add(TweenMax.to(n,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),l=(new TimelineMax).add(TweenMax.to(t,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(i).addTo(s),new ScrollMagic.Scene({triggerElement:"#triggerMision",duration:600,tweenChanges:!0}).setTween(r).addTo(s),new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(d).addTo(s),new ScrollMagic.Scene({triggerElement:"#triggerEsfuerzo",duration:600,tweenChanges:!0}).setTween(l).addTo(s)}function carruselEsfuerzo(){new Swiper(".slideresfuerzo",{loop:!0,direction:"horizontal",pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:"#next1",prevEl:"#prev1"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"1",allowTouchMove:!1}}})}function efectoFade3(){var e=1;document.body.addEventListener("wheel",(function(a){1==e?$(".navegacion").each((function(){var a=$(this).offset().top-40;$(window).scrollTop()>a?($("body").css("overflow","hidden"),setTimeout((function(){e=0,console.log(e)}),1e3)):(e=1,console.log(e),$("body").css("overflow","auto"))})):$("body").css("overflow","auto")}))}$(document).ready((function(){window.location.href.indexOf("destacamos")>-1&&($("body").addClass("body-destacamos"),$("#li-s3").addClass("activo"),drawSvgDestacamos(),carruselEsfuerzo(),efectoFade3())}));
