...
function drawSvgDestacamos(){function e(e){var o=e[0].getTotalLength();e.css("stroke-dasharray",o),e.css("stroke-dashoffset",o)}var o=$("#pathDedicamos"),n=$("#pathMision"),a=$("#pathAyuda"),s=$("#pathEsfuerzo");e(o),e(n),e(a),e(s);var t=new ScrollMagic.Controller,r=(new TimelineMax).add(TweenMax.to(o,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),d=(new TimelineMax).add(TweenMax.to(n,.3,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),i=(new TimelineMax).add(TweenMax.to(a,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),c=(new TimelineMax).add(TweenMax.to(s,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(r).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerMision",duration:600,tweenChanges:!0}).setTween(d).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(i).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerEsfuerzo",duration:600,tweenChanges:!0}).setTween(c).addTo(t)}function carruselEsfuerzo(){new Swiper(".slideresfuerzo",{loop:!0,direction:"horizontal",pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:"#next1",prevEl:"#prev1"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"1",allowTouchMove:!1}}})}function efectoFade3(){var e=1;document.body.addEventListener("wheel",(function(o){1==e?$(".navegacion").each((function(){var o=$(this).offset().top-40;$(window).scrollTop()>o?($("body").css("overflow","hidden"),setTimeout((function(){e=0,console.log(e)}),1e3)):(e=1,console.log(e),$("body").css("overflow","auto"))})):$("body").css("overflow","auto")}))}function stopScroll(){function e(){document.body.addEventListener("wheel",(function(e){if(function(e){if(e.wheelDelta)return e.wheelDelta>0;return e.deltaY<0}(e)){console.log("UP");var o=$(".esfuerzo").offset().top-100;$(window).scrollTop()>o&&$("body").css("background","red")}else console.log("down")}))}window.onscroll=function(o){e()}}function touchS(){var e;document.body.ontouchstart=function(o){e=o.changedTouches[0].clientY},document.body.ontouchmove=function(o){let n=o.changedTouches[0].clientY;if(n>e&&($("body").css("background","blue"),$("body").css("overflow","auto"),$("body").removeClass("onn")),n<e){var a=$(".esfuerzo").offset().top-100;$(window).scrollTop()>a?($("body").css("background","red"),$("body").addClass("onn"),$("body").css("overflow","hidden"),$(".esfuerzo").css("overflow-y","scroll")):($("body").css("background","green"),$("body").removeClass("onn"))}$("body").hasClass("onn")}}$(document).ready((function(){window.location.href.indexOf("destacamos")>-1&&($("body").addClass("body-destacamos"),$("#li-s3").addClass("activo"),drawSvgDestacamos(),carruselEsfuerzo(),touchS())}));
