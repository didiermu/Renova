...
function menu(){$(".header--navegacion .btn").on("click",function(){$(".header").toggleClass("headerOn"),$(this).toggleClass("nav-on")})}function efectoFade(){function e(){$("section").each(function(){if(window.matchMedia("(max-width: 992px)").matches){var e=$(this).offset().top-600;console.log("mobile home")}else{var e=$(this).offset().top-300;console.log("d home")}$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$("section").removeClass("sectionOn"),$(this).addClass("sectionOn")):$(this).find($(".objetFade")).removeClass("transition1")}),$(".home .dedicamos").hasClass("sectionOn")||$(".home .promos").hasClass("sectionOn")||$(".body-materiales .hero").hasClass("sectionOn")||$(".materiales .promos").hasClass("sectionOn")||$(".body-destacamos .hero").hasClass("sectionOn")||$(".body-destacamos .valores").hasClass("sectionOn")||$(".body-destacamos .esfuerzo").hasClass("sectionOn")||$(".body-servicios .hero").hasClass("sectionOn")||$(".body-servicios .nuestros").hasClass("sectionOn")?$(".header").addClass("black"):$(".header").removeClass("black"),$(".promos").hasClass("sectionOn")?setTimeout(function(){$(".promos .objetFade").addClass("objetFade-On")},2e3):$(".promos .objetFade").removeClass("objetFade-On")}e(),$(document).scroll(function(){e()})}function drawSvg(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathAyuda"),o=$("#pathDedicamos"),s=$("#pathPromos"),n=$("#pathContacto");e(a),e(o),e(s),e(n);var t=new ScrollMagic.Controller,i=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),r=(new TimelineMax).add(TweenMax.to(o,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),d=(new TimelineMax).add(TweenMax.to(s,.8,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),l=(new TimelineMax).add(TweenMax.to(n,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(i).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(r).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerPromos",duration:600,tweenChanges:!0}).setTween(d).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerContacto",duration:600,tweenChanges:!0}).setTween(l).addTo(t)}function carruselHome(){new Swiper(".sliderPromosHome",{direction:"horizontal",centeredSlidesBounds:!0,pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},breakpoints:{320:{slidesPerView:"auto",spaceBetween:10,allowTouchMove:!0},992:{slidesPerView:"auto",spaceBetween:10,slidesOffsetAfter:30,allowTouchMove:!1}}})}$(document).ready(function(){efectoFade(),$(window).enllax(),"/"==window.location.pathname&&(drawSvg(),carruselHome())});
