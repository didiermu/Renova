...
function menu(){$(".header--navegacion .btn").on("click",function(){$(".header").toggleClass("headerOn"),$(this).toggleClass("nav-on")})}function efectoFade(){function e(){$("section").each(function(){var e=$(this).offset().top-300;$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$("section").removeClass("sectionOn"),$(this).addClass("sectionOn")):$(this).find($(".objetFade")).removeClass("transition1")}),$(".dedicamos").hasClass("sectionOn")||$(".promos").hasClass("sectionOn")||$(".body-materiales .hero").hasClass("sectionOn")||$(".body-destacamos .hero").hasClass("sectionOn")||$(".body-destacamos .valores").hasClass("sectionOn")||$(".body-destacamos .esfuerzo").hasClass("sectionOn")?$(".header").addClass("black"):$(".header").removeClass("black"),$(".promos").hasClass("sectionOn")?setTimeout(function(){$(".promos .objetFade").addClass("objetFade-On")},2e3):$(".promos .objetFade").removeClass("objetFade-On")}e(),$(document).scroll(function(){e()})}function imgParallax(){$(".img-holder-hero").imageScroll({container:$(".hero"),speed:.9})}function drawSvg(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathAyuda"),n=$("#pathDedicamos"),o=$("#pathPromos"),s=$("#pathContacto");e(a),e(n),e(o),e(s);var t=new ScrollMagic.Controller,i=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),r=(new TimelineMax).add(TweenMax.to(n,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),d=(new TimelineMax).add(TweenMax.to(o,.8,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),c=(new TimelineMax).add(TweenMax.to(s,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(i).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(r).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerPromos",duration:600,tweenChanges:!0}).setTween(d).addTo(t),new ScrollMagic.Scene({triggerElement:"#triggerContacto",duration:600,tweenChanges:!0}).setTween(c).addTo(t)}$(document).ready(function(){menu(),efectoFade(),$(window).enllax(),"/"==window.location.pathname&&drawSvg()});
...
function drawSvgServicios(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathNuestros"),n=$("#pathCertificaciones");e(a),e(n);var i=new ScrollMagic.Controller,s=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),t=(new TimelineMax).add(TweenMax.to(n,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerNuestros",duration:600,tweenChanges:!0}).setTween(s).addTo(i),new ScrollMagic.Scene({triggerElement:"#triggerCertificaciones",duration:600,tweenChanges:!0}).setTween(t).addTo(i)}function tabsPromos(){$("#myTab a").on("click",function(e){$(".nav-item").removeClass("active"),$(this).parent("li").addClass("active"),$(".nav-tabs").addClass("nav-active")})}function carruselServicios1(){new Swiper(".sliderServicios",{direction:"horizontal",pagination:{el:"#pag1",type:"bullets",clickable:!0},navigation:{nextEl:"#nav1",prevEl:"#nav2"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3"}}})}$(document).ready(function(){window.location.href.indexOf("servicios")>-1&&(drawSvgServicios(),carruselServicios1(),tabsPromos())});
