...
function valText(s){var a=/^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$/,n=a.test(s.val());s.val().length<1?(s.siblings("span").remove(),s.after("<span class='error-input'>Campo requerido")):(s.siblings("span").remove(),n?s.siblings("span").remove():(s.siblings("span").remove(),s.after('<span class="error-input"> Solo se aceptan letras </span>'),s.siblings("span").show()))}function valTextNum(s){if(s.val().length<1||" "==s.val())s.siblings("span").remove(),s.after("<span class='error-input'>Campo requerido");else{s.siblings("span").remove();/^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$/.test(s.val())?s.siblings("span").remove():(s.siblings("span").remove(),s.after('<span class="error-input"> No se permiten caracteres especiales </span>'),s.siblings("span").show())}}function valNum(s){if(s.val().length<1)s.siblings("span").remove(),s.after("<span class='error-input'>Campo requerido");else{/^[0-9]+$/.test(s.val())?s.siblings("span").remove():(s.siblings("span").remove(),s.after('<span class="error-input"> Solo se permiten numeros </span>'),s.siblings("span").show())}}function valMail(s){if(s.val().length<1)s.siblings("span").remove(),s.after("<span class='error-input'>Campo requerido");else{/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(s.val())?s.siblings("span").remove():(s.siblings("span").remove(),s.after('<span class="error-input"> Verifica el formato de email </span>'),s.siblings("span").show())}}function valCombos(s){$(s).each(function(){$(this).change(function(){0!=$(this).val()&&$(this).parents(".combo").siblings("span").remove()}),0==$(this).val()?($(this).siblings("span").remove(),$(this).parents(".combo").after('<span class="error-input">Selecciona una opción</span>')):$(this).parents(".combo").siblings("span").remove()})}function validacionContacto(){$("#enviarContacto").on("click",function(){var s=$("#nombre"),a=$("#email"),n=$("#telefono");return comboAyuda=$("#comboAyuda"),msj=$("#mensaje"),valText(s),valMail(a),valNum(n),valTextNum(msj),valCombos($("#comboAyuda")),0==$("section.contacto .error-input").length&&$("section.contacto form").submit(),!1})}window.onload=function(){validacionContacto()};
function menu(){$("#linkContacto").on("click",function(){return $("html, body").animate({scrollTop:$(".contacto").offset().top-90},1500),!1})}function efectoFade(){function e(){$("section").each(function(){if(window.matchMedia("(max-width: 992px)").matches)var e=$(this).offset().top-600;else var e=$(this).offset().top-300;$(window).scrollTop()>e?($(this).find($(".objetFade")).addClass("transition1"),$("section").removeClass("sectionOn"),$(this).addClass("sectionOn")):$(this).find($(".objetFade")).removeClass("transition1")}),$(".home .ayuda").hasClass("sectionOn")||$(".home .dedicamos").hasClass("sectionOn")||$(".home .contacto").hasClass("sectionOn")||$(".body-materiales .hero").hasClass("sectionOn")||$(".materiales .promos").hasClass("sectionOn")||$(".body-destacamos .hero").hasClass("sectionOn")||$(".body-destacamos .valores").hasClass("sectionOn")||$(".body-destacamos .esfuerzo").hasClass("sectionOn")||$(".body-destacamos .dedicamos").hasClass("sectionOn")||$(".body-servicios .hero").hasClass("sectionOn")||$(".servicios .nuestros").hasClass("sectionOn")?$(".header").addClass("black"):$(".header").removeClass("black")}e(),$(document).scroll(function(){e()})}function drawSvg(){function e(e){var a=e[0].getTotalLength();e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a)}var a=$("#pathAyuda"),s=$("#pathDedicamos"),o=$("#pathContacto");e(a),e(s),e(o);var n=new ScrollMagic.Controller,t=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),i=(new TimelineMax).add(TweenMax.to(s,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),c=(new TimelineMax).add(TweenMax.to(o,.6,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(t).addTo(n),new ScrollMagic.Scene({triggerElement:"#triggerDedicamos",duration:600,tweenChanges:!0}).setTween(i).addTo(n),new ScrollMagic.Scene({triggerElement:"#triggerContacto",duration:600,tweenChanges:!0}).setTween(c).addTo(n)}$(function(){menu(),efectoFade(),$(window).enllax(),"/"!=window.location.pathname&&"/renova-industrial/"!=window.location.pathname&&"/RenovaIndustrial/"!=window.location.pathname||drawSvg()});
