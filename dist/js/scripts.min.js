...
function drawSvgServicios(){function e(e){var i=e[0].getTotalLength();e.css("stroke-dasharray",i),e.css("stroke-dashoffset",i)}var i=$("#pathNuestros"),a=$("#pathCertificaciones");e(i),e(a);var s=new ScrollMagic.Controller,r=(new TimelineMax).add(TweenMax.to(i,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0),n=(new TimelineMax).add(TweenMax.to(a,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerNuestros",duration:600,tweenChanges:!0}).setTween(r).addTo(s),new ScrollMagic.Scene({triggerElement:"#triggerCertificaciones",duration:600,tweenChanges:!0}).setTween(n).addTo(s)}function tabsPromos(){$("#myTab a").on("click",function(e){$(".nav-item").removeClass("active"),$(this).parent("li").addClass("active"),$(".nav-tabs").addClass("nav-active")})}function carruselServicios1(){new Swiper(".sliderServicios1",{observer:!0,observeParents:!0,loop:!0,direction:"horizontal",pagination:{el:"#pag1",type:"bullets",clickable:!0},navigation:{nextEl:"#nav2",prevEl:"#nav1"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:3,slidesOffsetAfter:100}}})}function carruselServicios2(){new Swiper(".sliderServicios2",{observer:!0,observeParents:!0,loop:!0,direction:"horizontal",pagination:{el:"#pag2",type:"bullets",clickable:!0},navigation:{nextEl:"#nav3",prevEl:"#nav4"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3",slidesOffsetAfter:100}}})}function carruselServicios3(){new Swiper(".sliderServicios3",{direction:"horizontal",observer:!0,observeParents:!0,loop:!0,pagination:{el:"#pag3",type:"bullets",clickable:!0},navigation:{nextEl:"#nav5",prevEl:"#nav6"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"3",slidesOffsetAfter:100}}})}$(document).ready(function(){window.location.href.indexOf("servicios")>-1&&(drawSvgServicios(),carruselServicios1(),carruselServicios2(),carruselServicios3(),tabsPromos())});
