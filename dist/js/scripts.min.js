...
function tabsMateriales(){$(".swiper-slide a").on("click",function(e){$(".swiper-slide").removeClass("active"),$(this).removeClass("active")})}function carruselMateriales(){new Swiper(".sliderMateriales",{direction:"horizontal",pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{320:{slidesPerView:"1",spaceBetween:10,allowTouchMove:!0,centeredSlidesBounds:!0},992:{slidesPerView:"auto",spaceBetween:30,slidesOffsetAfter:40,allowTouchMove:!1}}})}$(document).ready(function(){window.location.href.indexOf("materiales")>-1&&(tabsMateriales(),carruselMateriales())});
