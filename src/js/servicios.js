function drawSvgServicios() {
  ...
  var tween2 = new TimelineMax()
    .add(
      TweenMax.to($pathCertificaciones, 0.5, {
        strokeDashoffset: 0,
        ease: Linear.easeNone,
      })
    )
  ...
  var scene2 = new ScrollMagic.Scene({
    triggerElement: "#triggerNuestros",
    duration: 600,
    tweenChanges: true,
  })
    .setTween(tween)
  ...
  var scene3 = new ScrollMagic.Scene({
    triggerElement: "#triggerCertificaciones",
    duration: 600,
    tweenChanges: true,
  })
    .setTween(tween2)
  ...
  if (mediaqueryList.matches) {
    ...
    if ($("#myTabContent .modal").length == 3) {
      ...
      contenido.each(function (i, v) {
        $(this).wrapAll(
          "<div class='modal fade' id='servicio" +
            i +
